...
/// Local CA certificates page - displayed as a tab in CertificatesMainPage
class CertificatesLocalCAPage extends StatefulWidget {
  const CertificatesLocalCAPage({super.key});

  @override
  State<CertificatesLocalCAPage> createState() => _CertificatesLocalCAPageState();
}

class _CertificatesLocalCAPageState extends State<CertificatesLocalCAPage> {
  @override
  void initState() {
    super.initState();
